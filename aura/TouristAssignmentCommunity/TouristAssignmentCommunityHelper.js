({
    ...
    getConstantRegistration : function (cmp, constName) {
        let result = new Promise($A.getCallback( function (resolve, reject) {
            const getConstant = cmp.get('c.getConstantRegistration');
            
            getConstant.setCallback(this, function(res) {
                const state = res.getState();
                const values = res.getReturnValue();
            ...
            $A.enqueueAction(getConstant);
        }));
        
        return result;
    },
    
    getConstantPriceList : function (cmp, constName) {
        let result = new Promise($A.getCallback( function (resolve, reject) {
            const getConstant = cmp.get('c.getConstantPriceList');
